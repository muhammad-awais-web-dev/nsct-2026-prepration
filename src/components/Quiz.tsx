...
export default function Quiz({ category, onFinish, onAddLocalQuestions }: QuizProps) {
  const [questions, setQuestions] = useState<QuestionType[]>(() => shuffleOptions(category.questions));
